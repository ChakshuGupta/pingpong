...
OUTPUT_DIR="$2/standalone"
readonly OUTPUT_DIR

LOCAL_DIR="$1/local-phone/standalone"
readonly LOCAL_DIR

REMOTE_DIR="$1/remote-phone/standalone"
readonly REMOTE_DIR

IFTTT_DIR="$1/ifttt/standalone"
readonly IFTTT_DIR
...
# =================================================== AMAZON PLUG ======================================================
# LOCAL
INPUT_PCAP="$LOCAL_DIR/amazon-plug/wlan1/amazon-plug.wlan1.local.pcap"

# Device Signature
OUTPUT_PCAP="$OUTPUT_DIR/amazon-plug/wlan1/amazon-plug-processed.pcap"
TIMESTAMP_FILE="$LOCAL_DIR/amazon-plug/timestamps/amazon-plug-apr-16-2019.timestamps"
...
# # ======================================================================================================================
# # REMOTE
INPUT_PCAP="$REMOTE_DIR/amazon-plug/wlan1/amazon-plug.wlan1.remote.pcap"

# Device Signature
OUTPUT_PCAP="$REMOTE_DIR/amazon-plug/wlan1/amazon-plug-processed.pcap"
TIMESTAMP_FILE="$REMOTE_DIR/amazon-plug/timestamps/amazon-plug-dec-6-2019.timestamps"
DEVICE_IP="192.168.1.189"
ON_SIGNATURE="$REMOTE_DIR/amazon-plug/signatures/amazon-plug-onSignature-device-side.sig"
OFF_SIGNATURE="$REMOTE_DIR/amazon-plug/signatures/amazon-plug-offSignature-device-side.sig"
ON_ANALYSIS="$REMOTE_DIR/amazon-plug/analyses/amazon-plug-onClusters-device-side.cls"
OFF_ANALYSIS="$REMOTE_DIR/amazon-plug/analyses/amazon-plug-offClusters-device-side.cls"
EPSILON="10.0"
...
# # ==================================================== ARLO CAMERA =====================================================
# LOCAL
INPUT_PCAP="$LOCAL_DIR/arlo-camera/wlan1/arlo-camera.wlan1.local.pcap"

# Has no device side signature.
# PHONE SIDE
OUTPUT_PCAP="$OUTPUT_DIR/arlo-camera/wlan1/arlo-camera-processed.pcap"
TIMESTAMP_FILE="$LOCAL_DIR/arlo-camera/timestamps/arlo-camera-nov-13-2018.timestamps"
...
INPUT_PCAP="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/wlan1/arlo-camera-startrecording.wlan1.ifttt.pcap"

# DEVICE SIDE
OUTPUT_PCAP="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/wlan1/arlo-camera-processed.pcap"
TIMESTAMP_FILE="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/timestamps/arlo-camera-startrecording-ifttt-dec-15-2019.timestamps"
DEVICE_IP="192.168.1.142"
ON_SIGNATURE="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/signatures/arlo-camera-startrecording-onSignature-device-side.sig"
OFF_SIGNATURE="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/signatures/arlo-camera-startrecording-offSignature-device-side.sig"
ON_ANALYSIS="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/analyses/arlo-camera-startrecording-onClusters-device-side.cls"
OFF_ANALYSIS="$IFTTT_DIR/arlo-camera/arlo-camera-startrecording/analyses/arlo-camera-startrecording-offClusters-device-side.cls"
EPSILON="10.0"
...
DEVICE SIDE
INPUT_PCAP="$LOCAL_DIR/blossom-sprinkler/blossom-sprinkler-quickrun/wlan1/blossom-sprinkler-quickrun.wlan1.local.pcap"
OUTPUT_PCAP="$OUTPUT_DIR/blossom-sprinkler/blossom-sprinkler-quickrun/wlan1/blossom-sprinkler-quickrun-processed.pcap"
TIMESTAMP_FILE="$LOCAL_DIR/blossom-sprinkler/blossom-sprinkler-quickrun/timestamps/blossom-sprinkler-quickrun-jan-14-2019.timestamps"
...
INPUT_PCAP="$LOCAL_DIR/blossom-sprinkler/blossom-sprinkler-mode/wlan1/blossom-sprinkler-mode.wlan1.local.pcap"

# PHONE SIDE
OUTPUT_PCAP="$OUTPUT_DIR/blossom-sprinkler/blossom-sprinkler-mode/wlan1/blossom-sprinkler-mode-processed.pcap"
TIMESTAMP_FILE="$LOCAL_DIR/blossom-sprinkler/blossom-sprinkler-mode/timestamps/blossom-sprinkler-mode-apr-15-2019.timestamps"
DEVICE_IP="192.168.1.246"
...
# LOCAL
# DEVICE SIDE
INPUT_PCAP="$LOCAL_DIR/dlink-plug/wlan1/dlink-plug.wlan1.local.pcap"
OUTPUT_PCAP="$OUTPUT_DIR/dlink-plug/wlan1/dlink-plug-processed.pcap"
TIMESTAMP_FILE="$LOCAL_DIR/dlink-plug/timestamps/dlink-plug-nov-7-2018.timestamps"
...
# REMOTE
# DEVICE SIDE
INPUT_PCAP="$REMOTE_DIR/dlink-plug/wlan1/dlink-plug.wlan1.remote.pcap"
OUTPUT_PCAP="$REMOTE_DIR/dlink-plug/wlan1/dlink-plug-processed.pcap"
TIMESTAMP_FILE="$REMOTE_DIR/dlink-plug/timestamps/dlink-plug-dec-2-2019.timestamps"
DEVICE_IP="192.168.1.199"
ON_SIGNATURE="$REMOTE_DIR/dlink-plug/signatures/dlink-plug-onSignature-device-side.sig"
OFF_SIGNATURE="$REMOTE_DIR/dlink-plug/signatures/dlink-plug-offSignature-device-side.sig"
ON_ANALYSIS="$REMOTE_DIR/dlink-plug/analyses/dlink-plug-onClusters-device-side.cls"
OFF_ANALYSIS="$REMOTE_DIR/dlink-plug/analyses/dlink-plug-offClusters-device-side.cls"
EPSILON="10.0"
DELETED_SEQUENCES_ON="-1"
DELETED_SEQUENCES_OFF="-1"
...
# IFTTT
# DEVICE SIDE
INPUT_PCAP="$IFTTT_DIR/dlink-plug/wlan1/dlink-plug.wlan1.ifttt.pcap"
OUTPUT_PCAP="$IFTTT_DIR/dlink-plug/wlan1/dlink-plug-processed.pcap"
TIMESTAMP_FILE="$IFTTT_DIR/dlink-plug/timestamps/dlink-plug-ifttt-dec-11-2019.timestamps"
DEVICE_IP="192.168.1.199"
ON_SIGNATURE="$OUTPUT_DIR/dlink-plug/signatures/dlink-plug-onSignature-device-side.sig"
OFF_SIGNATURE="$OUTPUT_DIR/dlink-plug/signatures/dlink-plug-offSignature-device-side.sig"
ON_ANALYSIS="$OUTPUT_DIR/dlink-plug/analyses/dlink-plug-onClusters-device-side.cls"
...
# ==================================================== D-LINK SIREN ====================================================
# LOCAL
# INPUT_PCAP="$LOCAL_DIR/dlink-siren/wlan1/dlink-siren.wlan1.local.pcap"

# # Has no device side signature.
# # PHONE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/dlink-siren/wlan1/dlink-siren-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/dlink-siren/timestamps/dlink-siren-nov-9-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/dlink-siren/wlan1/dlink-siren.wlan1.ifttt.pcap"

# # Has no device side signature.
# # DEVICE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/dlink-siren/wlan1/dlink-siren-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/dlink-siren/timestamps/dlink-siren-ifttt-dec-14-2019.timestamps"
...
# INPUT_PCAP="$LOCAL_DIR/ecobee-thermostat/ecobee-thermostat-hvac/wlan1/ecobee-thermostat-hvac.wlan1.local.pcap"

# # Phone Signature
# OUTPUT_PCAP="$OUTPUT_DIR/ecobee-thermostat/ecobee-thermostat-hvac/wlan1/ecobee-thermostat-hvac-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/ecobee-thermostat/ecobee-thermostat-hvac/timestamps/ecobee-thermostat-hvac-apr-17-2019.timestamps"
...
# INPUT_PCAP="$LOCAL_DIR/ecobee-thermostat/ecobee-thermostat-fan/wlan1/ecobee-thermostat-fan.wlan1.local.pcap"

# # Phone Signature
# OUTPUT_PCAP="$OUTPUT_DIR/ecobee-thermostat/ecobee-thermostat-fan/wlan1/ecobee-thermostat-fan-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/ecobee-thermostat/ecobee-thermostat-fan/timestamps/ecobee-thermostat-fan-apr-18-2019.timestamps"
# DEVICE_IP="192.168.1.130"
...
# # ======================================================= HUE BULB =====================================================
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/hue-bulb/eth1/hue-bulb.eth1.local.pcap"

# # DEVICE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/hue-bulb/eth1/hue-bulb-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/hue-bulb/timestamps/hue-bulb-sept-11-2019.timestamps"
...
# # ================================================== HUE BULB ON/OFF ===================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/hue-bulb/hue-bulb-onoff/eth1/hue-bulb-onoff.eth1.ifttt.pcap"

# # DEVICE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/hue-bulb/hue-bulb-onoff/eth1/hue-bulb-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/hue-bulb/hue-bulb-onoff/timestamps/hue-bulb-onoff-ifttt-dec-15-2019.timestamps"
...
# # ================================================ HUE BULB INTENSITY ==================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/hue-bulb/hue-bulb-intensity/eth1/hue-bulb-intensity.eth1.ifttt.pcap"
...
# TIMESTAMP_FILE="$LOCAL_DIR/hue-bulb/hue-bulb-intensity/timestamps/hue-bulb-intensity-ifttt-dec-20-2019.timestamps"
# DEVICE_IP="192.168.1.100"
...
# # ================================================= KWIKSET DOORLOCK ===================================================
# INPUT_PCAP="$LOCAL_DIR/kwikset-doorlock/wlan1/kwikset-doorlock.wlan1.local.pcap"

# # Has no device side signature.
# # PHONE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/kwikset-doorlock/wlan1/kwikset-doorlock-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/kwikset-doorlock/timestamps/kwikset-doorlock-nov-10-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ================================================= NEST THERMOSTAT ====================================================
# INPUT_PCAP="$LOCAL_DIR/nest-thermostat/wlan1/nest-thermostat.wlan1.local.pcap"

# # Has no device side signature.
# # PHONE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/nest-thermostat/wlan1/nest-thermostat-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/nest-thermostat/timestamps/nest-thermostat-nov-15-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/wlan1/rachio-sprinkler-quickrun.wlan1.local.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/wlan1/rachio-sprinkler-quickrun-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/timestamps/rachio-sprinkler-quickrun-apr-18-2019.timestamps"
...
# # ======================================================================================================================
# # REMOTE
# INPUT_PCAP="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/wlan1/rachio-sprinkler-quickrun.wlan1.remote.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/wlan1/rachio-sprinkler-quickrun-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/timestamps/rachio-sprinkler-quickrun-dec-4-2019.timestamps"
# DEVICE_IP="192.168.1.143"
# ON_SIGNATURE="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/signatures/rachio-sprinkler-quickrun-onSignature-device-side.sig"
# OFF_SIGNATURE="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/signatures/rachio-sprinkler-quickrun-offSignature-device-side.sig"
# ON_ANALYSIS="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/analyses/rachio-sprinkler-quickrun-onClusters-device-side.cls"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/wlan1/rachio-sprinkler-quickrun.wlan1.ifttt.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/wlan1/rachio-sprinkler-quickrun-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-quickrun/timestamps/rachio-sprinkler-quickrun-ifttt-dec-12-2019.timestamps"
...
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-mode/wlan1/rachio-sprinkler-mode.wlan1.local.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-mode/wlan1/rachio-sprinkler-mode-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-mode/timestamps/rachio-sprinkler-mode-apr-18-2019.timestamps"
# DEVICE_IP="192.168.1.143"
...
# # ======================================================================================================================
# # REMOTE
# INPUT_PCAP="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-mode/wlan1/rachio-sprinkler-mode.wlan1.remote.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-mode/wlan1/rachio-sprinkler-mode-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/rachio-sprinkler/rachio-sprinkler-mode/timestamps/rachio-sprinkler-mode-dec-4-2019.timestamps"
# DEVICE_IP="192.168.1.143"
# ON_SIGNATURE="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-mode/signatures/rachio-sprinkler-mode-onSignature-device-side.sig"
# OFF_SIGNATURE="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-mode/signatures/rachio-sprinkler-mode-offSignature-device-side.sig"
# ON_ANALYSIS="$OUTPUT_DIR/rachio-sprinkler/rachio-sprinkler-mode/analyses/rachio-sprinkler-mode-onClusters-device-side.cls"
...
# # ===================================================== RING ALARM =====================================================
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/ring-alarm/wlan1/ring-alarm.wlan1.local.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/ring-alarm/wlan1/alarm-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/ring-alarm/timestamps/ring-alarm-apr-26-2019.timestamps"
...
# # ======================================================================================================================
# # REMOTE
# INPUT_PCAP="$LOCAL_DIR/ring-alarm/wlan1/ring-alarm.wlan1.remote.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/ring-alarm/wlan1/alarm-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/ring-alarm/timestamps/ring-alarm-dec-9-2019.timestamps"
# DEVICE_IP="192.168.1.113"
# ON_SIGNATURE="$OUTPUT_DIR/ring-alarm/signatures/ring-alarm-onSignature-device-side.sig"
# OFF_SIGNATURE="$OUTPUT_DIR/ring-alarm/signatures/ring-alarm-offSignature-device-side.sig"
# ON_ANALYSIS="$OUTPUT_DIR/ring-alarm/analyses/ring-alarm-onClusters-device-side.cls"
...
# # ================================================= ROOMBA VACUUM ROBOT ================================================
# INPUT_PCAP="$LOCAL_DIR/roomba-vacuum-robot/wlan1/roomba-vacuum-robot.wlan1.local.pcap"

# # Device Signature
# OUTPUT_PCAP="$OUTPUT_DIR/roomba-vacuum-robot/wlan1/roomba-vacuum-robot-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/roomba-vacuum-robot/timestamps/roomba-vacuum-robot-apr-25-2019.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # =============================================== SENGLED BULB ON/OFF ==================================================
# INPUT_PCAP="$LOCAL_DIR/sengled-bulb/sengled-bulb-onoff/wlan1/sengled-bulb-onoff.wlan1.local.pcap"

# # Phone Signature
# OUTPUT_PCAP="$OUTPUT_DIR/sengled-bulb/sengled-bulb-onoff/wlan1/sengled-bulb-onoff-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/sengled-bulb/sengled-bulb-onoff/timestamps/sengled-bulb-onoff-apr-24-2019.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/sengled-bulb/sengled-bulb-onoff/eth1/sengled-bulb-onoff.eth1.local.pcap"
...
# INPUT_PCAP="$LOCAL_DIR/sengled-bulb/sengled-bulb-intensity/wlan1/sengled-bulb-intensity.wlan1.local.pcap"

# # Phone Signature
# OUTPUT_PCAP="$OUTPUT_DIR/sengled-bulb/sengled-bulb-intensity/wlan1/sengled-bulb-intensity-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/sengled-bulb/sengled-bulb-intensity/timestamps/sengled-bulb-intensity-apr-17-2019.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/sengled-bulb/sengled-bulb-intensity/eth1/sengled-bulb-intensity.eth1.local.pcap"
...
# # ====================================================== ST PLUG =======================================================
# INPUT_PCAP="$LOCAL_DIR/st-plug/wlan1/st-plug.wlan1.local.pcap"

# # Has no device side signature.
# # PHONE SIDE
# OUTPUT_PCAP="$OUTPUT_DIR/st-plug/wlan1/st-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/st-plug/timestamps/st-plug-nov-12-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ================================================= TP LINK BULB ON/OFF ================================================
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb/tplink-bulb-onoff/wlan1/tplink-bulb-onoff.wlan1.local.pcap"

# # Has LAN signature.
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb/tplink-bulb-onoff/wlan1/tplink-bulb-onoff-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-onoff/timestamps/tplink-bulb-onoff-nov-16-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb/tplink-bulb-onoff/wlan1/tplink-bulb-onoff.wlan1.ifttt.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb/tplink-bulb-onoff/wlan1/tplink-bulb-onoff-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-onoff/timestamps/tplink-bulb-onoff-ifttt-dec-14-2019.timestamps"
...
# # ================================================= TP LINK BULB COLOR =================================================
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb/tplink-bulb-color/wlan1/tplink-bulb-color.wlan1.local.pcap"
...
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-color/timestamps/tplink-bulb-color-apr-12-2019.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb/tplink-bulb-color/wlan1/tplink-bulb-color.wlan1.ifttt.pcap"

# # No signature found for both phone and device sides
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb/tplink-bulb-color/wlan1/tplink-bulb-color-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-color/timestamps/tplink-bulb-color-ifttt-dec-18-2019.timestamps"
...
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb/tplink-bulb-intensity/wlan1/tplink-bulb-intensity.wlan1.local.pcap"

# # No signature found for both phone and device sides
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb/tplink-bulb-intensity/wlan1/tplink-bulb-intensity-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-intensity/timestamps/tplink-bulb-intensity-apr-29-2019.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb/tplink-bulb-intensity/wlan1/tplink-bulb-intensity.wlan1.ifttt.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb/tplink-bulb-intensity/wlan1/tplink-bulb-intensity-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-intensity/timestamps/tplink-bulb-intensity-ifttt-dec-17-2019.timestamps"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb/tplink-bulb-intensity/timestamps/tplink-bulb-intensity-ifttt-dec-18-2019.timestamps"
# DEVICE_IP="192.168.1.140"
...
# INPUT_PCAP="$LOCAL_DIR/tplink-plug/wlan1/tplink-plug.wlan1.local.pcap"

# # LAN signature.
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-plug/wlan1/tplink-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-plug/timestamps/tplink-plug-nov-8-2018.timestamps"
...
# # ======================================================================================================================
# # REMOTE
# INPUT_PCAP="$LOCAL_DIR/tplink-plug/wlan1/tplink-plug.wlan1.remote.pcap"

# # LAN signature.
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-plug/wlan1/tplink-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-plug/timestamps/tplink-plug-dec-2-2019.timestamps"
# DEVICE_IP="192.168.1.159"
# ON_SIGNATURE="$OUTPUT_DIR/tplink-plug/signatures/tplink-plug-onSignature-device-side.sig"
# OFF_SIGNATURE="$OUTPUT_DIR/tplink-plug/signatures/tplink-plug-offSignature-device-side.sig"
# ON_ANALYSIS="$OUTPUT_DIR/tplink-plug/analyses/tplink-plug-onClusters-device-side.cls"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/tplink-plug/wlan1/tplink-plug.wlan1.ifttt.pcap"

# # LAN signature.
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-plug/wlan1/tplink-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-plug/timestamps/tplink-plug-ifttt-dec-10-2019.timestamps"
# DEVICE_IP="192.168.1.159"
# ON_SIGNATURE="$OUTPUT_DIR/tplink-plug/signatures/tplink-plug-onSignature-device-side.sig"
# OFF_SIGNATURE="$OUTPUT_DIR/tplink-plug/signatures/tplink-plug-offSignature-device-side.sig"
# ON_ANALYSIS="$OUTPUT_DIR/tplink-plug/analyses/tplink-plug-onClusters-device-side.cls"
...
# # ================================================== WEMO INSIGHT PLUG =================================================
# INPUT_PCAP="$LOCAL_DIR/wemo-insight-plug/wlan1/wemo-insight-plug.wlan1.local.pcap"

# # Has LAN signature.
# OUTPUT_PCAP="$OUTPUT_DIR/wemo-insight-plug/wlan1/wemo-insight-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/wemo-insight-plug/timestamps/wemo-insight-plug-nov-21-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/wemo-insight-plug/wlan1/wemo-insight-plug.wlan1.ifttt.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/wemo-insight-plug/wlan1/wemo-insight-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/wemo-insight-plug/timestamps/wemo-insight-plug-ifttt-dec-14-2019.timestamps"
...
# # ===================================================== WEMO PLUG ======================================================
# # LOCAL
# INPUT_PCAP="$LOCAL_DIR/wemo-plug/wlan1/wemo-plug.wlan1.local.pcap"

# # Has LAN signature.
# OUTPUT_PCAP="$OUTPUT_DIR/wemo-plug/wlan1/wemo-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/wemo-plug/timestamps/wemo-plug-nov-20-2018.timestamps"
# DEVICE_IP="192.168.1.246"
...
# # ======================================================================================================================
# # IFTTT
# INPUT_PCAP="$LOCAL_DIR/wemo-plug/wlan1/wemo-plug.wlan1.ifttt.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/wemo-plug/wlan1/wemo-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/wemo-plug/timestamps/wemo-plug-ifttt-dec-16-2019.timestamps"
...
# INPUT_PCAP="$LOCAL_DIR/tplink-two-outlet-plug/wlan1/tplink-two-outlet-plug.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-two-outlet-plug/wlan1/tplink-two-outlet-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-two-outlet-plug/timestamps/tplink-two-outlet-plug-dec-22-2019.timestamps"
...
# # ================================================= TP-LINK POWER STRIP ================================================
# INPUT_PCAP="$LOCAL_DIR/tplink-power-strip/wlan1/tplink-power-strip.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-power-strip/wlan1/tplink-power-strip-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-power-strip/timestamps/tplink-power-strip-dec-22-2019.timestamps"
# DEVICE_IP="192.168.1.142"
...
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb-white/tplink-bulb-white-onoff/wlan1/tplink-bulb-white-onoff.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb-white/tplink-bulb-white-onoff/wlan1/tplink-bulb-white-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb-white/tplink-bulb-white-onoff/timestamps/tplink-bulb-white-onoff-dec-21-2019.timestamps"
...
# # KL-110 (newer model than LB-130 but no color---only dimmable white)
# INPUT_PCAP="$LOCAL_DIR/tplink-bulb-white/tplink-bulb-white-intensity/wlan1/tplink-bulb-white-intensity.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-bulb-white/tplink-bulb-white-intensity/wlan1/tplink-bulb-white-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-bulb-white/tplink-bulb-white-intensity/timestamps/tplink-bulb-white-intensity-dec-21-2019.timestamps"
# DEVICE_IP="192.168.1.227"
...
# INPUT_PCAP="$LOCAL_DIR/tplink-camera/tplink-camera-onoff/wlan1/tplink-camera-onoff.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-camera/tplink-camera-onoff/wlan1/tplink-light-camera-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-camera/tplink-camera-onoff/timestamps/tplink-camera-onoff-dec-22-2019.timestamps"
...
# INPUT_PCAP="$LOCAL_DIR/tplink-camera/tplink-camera-recording/wlan1/tplink-camera-recording.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/tplink-camera/tplink-camera-recording/wlan1/tplink-light-camera-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-camera/tplink-camera-recording/timestamps/tplink-camera-recording-dec-22-2019.timestamps"
# DEVICE_IP="192.168.1.235"
...
# OUTPUT_PCAP="$OUTPUT_DIR/tplink-plug/wlan1/tplink-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/tplink-plug/timestamps/tplink-plug-retraining-dec-25-2019.timestamps"
...
# OUTPUT_PCAP="$OUTPUT_DIR/wemo-insight-plug/wlan1/wemo-insight-plug-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/wemo-insight-plug/timestamps/wemo-insight-plug-retraining-jan-9-2020.timestamps"
...
# # Mon(IoT)r DATASET
# # ================================================= BLINK CAMERA WATCH =================================================
# INPUT_PCAP="$LOCAL_DIR/blink-camera/blink-camera-watch/wlan1/blink-camera-watch.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/blink-camera/blink-camera-watch/wlan1/blink-camera-watch-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/blink-camera/blink-camera-watch/timestamps/blink-camera-watch-retraining-dec-23-2019.timestamps"
...
# # ================================================= BLINK CAMERA PHOTO =================================================
# INPUT_PCAP="$LOCAL_DIR/blink-camera/blink-camera-photo/wlan1/blink-camera-photo.wlan1.local.pcap"

# OUTPUT_PCAP="$OUTPUT_DIR/blink-camera/blink-camera-photo/wlan1/blink-camera-photo-processed.pcap"
# TIMESTAMP_FILE="$LOCAL_DIR/blink-camera/blink-camera-photo/timestamps/blink-camera-photo-retraining-dec-24-2019.timestamps"
# DEVICE_IP="192.168.1.228"
